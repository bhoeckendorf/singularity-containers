...
#  Default: ''
c.ServerApp.certfile = '/etc/ssl/certs/bh-selfsigned.crt'
...
#  they are limited.
#  Default: 1000000
c.ServerApp.iopub_data_rate_limit = 1e12
...
#  Default: ''
c.ServerApp.keyfile = '/etc/ssl/private/bh-selfsigned.key'
...
#  Default: ''
c.ServerApp.password = 'sha1:21ad048066d4:4448972567e4f4a464b27aead1d3eee3fc9f524b'
...
#  Choices: any of ['sha384', 'blake2s', 'sha224', 'sha512', 'sha1', 'sha3_256', 'sha3_384', 'blake2b', 'sha3_512', 'sha3_224', 'sha256', 'md5']
#  Default: 'sha256'
